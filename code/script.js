...
function renderPlaces(places) {
   ...
   places.forEach((place) => {
	   ...
	   model_1.setAttribute('gps-entity-place', `latitude: ${latitude}; longitude: ${longitude};`);
	   ...
	   model_2.setAttribute('gps-entity-place', `latitude: ${latitude}; longitude: ${longitude};`);
	   ...
	   model_3.setAttribute('gps-entity-place', `latitude: ${latitude}; longitude: ${longitude};`);
	   ...
	   model_4.setAttribute('gps-entity-place', `latitude: ${latitude}; longitude: ${longitude};`);
